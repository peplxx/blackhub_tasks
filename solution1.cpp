/*
Задача 1
Дана двумерная последовательность uint32_t элементов размером N × M, представленная в виде одномерного массива.
Каждый элемент принимает значение 0 или 1. Элементы со значением 1, имеющие соседей со значением 1 по горизонтали или вертикали, образуют остров.
Необходимо реализовать наиболее оптимизированное по времени решение для подсчёта количества островов в последовательности.
Допускается изменение исходной последовательности.
*/
